                ...
                if ("click" === targetType) {
                    if (targetEvent.closest("[data-showmore-button]")) {
                        ...
                        if (!showMoreContent.classList.contains("_slide")) {
                            console.log("showMoreContent, showMoreSpeed, hiddenHeight :>> ", showMoreContent, showMoreSpeed, hiddenHeight);
                    ...
                    document.querySelector("._showmore-active")?.classList.remove("_showmore-active");
                }
            }
        }));
    }
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            ...
            function startSlider() {
                if (window.innerWidth >= 768 && "false" == slider.dataset.desktop) {
